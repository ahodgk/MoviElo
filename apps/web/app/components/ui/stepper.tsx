    ...
    >
      <svg width={size} height={size}>
        ...
        <circle
          ...
          className="text-zinc-900 transition-all duration-300 ease-in-out dark:text-zinc-50"
...
const classForSeparator = cva(
  [
    ...
    "data-[state=completed]:bg-zinc-900 data-[disabled]:opacity-50 dark:data-[state=completed]:bg-zinc-50",
